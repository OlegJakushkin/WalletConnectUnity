...
namespace WalletConnectSharp.Core.Models
{
    ...
    public class JsonRpcRequest : IEventSource
    {
        ...
        public static JsonRpcRequestMethod[] Methods { get; } = new[]
        {
            ...
            new JsonRpcRequestMethod()
                { Name = ValidJsonRpcRequestMethods.WalletSwitchEthereumChain, IsSigning = true },
        };

        [JsonIgnore] private static readonly string WalletConnectMethodPrefix = "wc_";
        ...
        [JsonProperty(Order = 1)] private readonly long id;
        [JsonProperty(Order = 2)] private const string JSONRPC = "2.0";

        [JsonProperty("method", Order = 3)] public virtual string Method { get; protected set; }
        ...
        public static bool IsSigningMethod(string method) =>
            Array.Exists(SigningMethods, wcMethod => wcMethod.Name == method);
        ...
        [JsonIgnore] public string JsonRPC => JSONRPC;

        [JsonIgnore] public string Event => Method;
    }
